...
var PointType = ['ATM', 'Gas station', 'Bus stop'];
var LineType = ['Highway', 'Road', 'River'];
var PolygonType = ['Lake', 'SportFields','Building'];
...
var myview = new ol.View({
    center : [11780875.917562773, 2393280.2642628467],
    zoom:14
})
...
// Geolocation 
  // set up geolocation to track your position
